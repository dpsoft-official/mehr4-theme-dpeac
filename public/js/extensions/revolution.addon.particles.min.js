(function () {
    ...
    window.RsParticlesAddOn = function (f) {
        ...
        function m() {
            var a =
                document.getElementById(q), b = document.querySelector(u);
        ...
        if (f) {
            var l = f[0].opt.particles, p = l.startSlide, n = l.endSlide, a = l.particles, b = a.line_linked,
                c = a.shape, d = a.color, h = c.stroke, a = h.width, r = f[0].id, z, e, y, w, x, u, v, A, q;
            q = r + "-rs-particles";
            d.value = d.value.split(",");
            h.color = a ? B(h.color.split(","), h.opacity) : h.color.split(",");
            d = l.interactivity.events.onhover;
            if (b.enable || d.enable && "grab" === d.mode) for (b =
            ...
            f.one("revolution.slide.onchange", function () {
                var a,
                    b = l.zIndex, c = r + "-tp-particles-", d = l.interactivity.events,
    ...
    var C = function (f, k, g, m, l) {
        ...
        this.tpId = m;
        var a = this.pJS = {
            canvas: {el: f, w: f.offsetWidth, h: f.offsetHeight}, particles: {
                ...
                opacity: {value: 1, random: !1, min: .1, anim: {enable: !1, speed: 2, opacity_min: 0, sync: !1}},
                size: {value: 20, random: !1, min: 1, anim: {enable: !1, speed: 20, size_min: 0, sync: !1}},
                line_linked: {enable: !1, distance: 100, color: "#fff", opacity: 1, width: 1},
                move: {
                    enable: !0,
                    speed: 2,
                    direction: "none",
                ...
                mouse: {}
            }, retina_detect: !1, offset: l.offset(), fn: {interact: {}, modes: {}, vendors: {}}, tmp: {}
        };
        ...
        a.fn.retinaInit = function () {
            a.retina_detect && 1 < window.devicePixelRatio ? (a.canvas.pxratio = window.devicePixelRatio, a.tmp.retina =
                !0) : (a.canvas.pxratio = 1, a.tmp.retina = !1);
        ...
        a.fn.particlesUpdate = function () {
            for (var b, c, d, h, f = a.particles.array.length, g = 0; g < f; g++) {
                ...
                if (a.particles.line_linked.enable || a.particles.move.attract.enable) for (b = a.particles.array.length, c = g + 1; c < b; c++) d = a.particles.array[c], a.particles.line_linked.enable && a.fn.interact.linkParticles(e,
        ...
        a.fn.interact.linkParticles = function (b, c) {
            var d = b.x - c.x, h = b.y - c.y, d = Math.sqrt(d * d + h * h);
        ...
        a.fn.modes.bubbleParticle = function (b) {
            if (a.interactivity.events.onhover.enable && -1 < a.interactivity.events.onhover.mode.indexOf("bubble")) {
                var c =
                    b.x - a.interactivity.mouse.pos_x, d = b.y - a.interactivity.mouse.pos_y,
                    c = Math.sqrt(c * c + d * d), d = 1 - c / a.interactivity.modes.bubble.distance;
        ...
        a.fn.modes.grabParticle = function (b) {
            if (a.interactivity.events.onhover.enable && "mousemove" == a.interactivity.status) {
                var c = b.x - a.interactivity.mouse.pos_x, d = b.y - a.interactivity.mouse.pos_y,
                    c = Math.sqrt(c * c + d * d);
                c <=
        ...
        a.fn.vendors.checkOverlap = function (b, c) {
            for (var d = a.particles.array.length, f = 0; f < d; f++) {
                var g = a.particles.array[f], k = b.x - g.x, e = b.y - g.y;
        ...
        a.fn.vendors.createSvgImg = function (b) {
            var c = a.tmp.source_svg.replace(/#([0-9A-F]{3,6})/gi, n.call(b)).replace("{{stroke-color}}", b.strokeColor),
                d = new Image, c = "data:image/svg+xml;base64," + btoa(c);
